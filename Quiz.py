...
class MainWindow:
    ...
    def __init__(self, master):
        ...
        self.master.title("Offline Quiz")
        self.master.config(bg="#009FBF")

        f = Frame(self.master, height=1080, width=1920, bg="azure", relief="ridge", bd=20)
        f.propagate(0)
        f.pack()
        self.man = PhotoImage(file=r"E:\OSTL\miniproject\quiz\Resources\\imag.png")
...
class Register:
    ...
    def __init__(self, master):
        ...
        self.regNow = PhotoImage(file="E:\OSTL\miniproject\quiz\Resources\RegisterNow.png")
...
class Quiz:
    def __init__(self, master, u):
        ...
        filestr = r"E:\OSTL\miniproject\quiz\Resources\\" + str(imgID) + ".png"  
